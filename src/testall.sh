...
Check() {
    ...
    Run "$CC" "-o" "${basename}.exe" "${basename}.s" "printbig.o" "list.o" "graph.o" "graph_visualization.o" " -lGL -lGLU -lglfw -lX11 -lglad -lXxf86vm -lXrandr -lpthread -lXi -ldl -lm" && #changed lglad to path
